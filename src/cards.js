...
export function createJobCard(job) {
  ...
  <div class="sc-4d881605-0 kokxPe">
      <div class="sc-9de900ec-0 khWrGf">
          <div aria-live="polite" id="" class="sc-kLLXSd hHAGuT"><button aria-label="This company has Feedback Badge"
                  aria-expanded="false" tabindex="-1" aria-hidden="true" class="sc-jIZahH cuCZMH">
                  <div data-testid="friendly-badge-infotip"><span
                          style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span
                              style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img
                                  ...
                                  src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2732%27%20height=%2746%27/%3e"
                              ...
                              alt="" src="/images/friendly-gupy-badge.svg" decoding="async" data-nimg="intrinsic"
                              srcset="/images/friendly-gupy-badge.svg 1x, /images/friendly-gupy-badge.svg 2x"
                  ...
                  <div aria-hidden="true" class="sc-4d881605-3 XmfhX"><span
                          style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span
                              style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img
                                  ...
                                  style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img
                              alt="Company logo"
                              src="/_next/image?url=${job.careerPageLogo}&amp;w=64&amp;q=75"
                              decoding="async" data-nimg="intrinsic" class="sc-ab49f641-0 kDrzQb"
                              srcset="/_next/image?url=${job.careerPageLogo}&amp;w=32&amp;q=75 1x, /_next/image?url=${job.careerPageLogo}&amp;w=64&amp;q=75 2x"
                              style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"><noscript></noscript></span>
                      <p class="sc-bBXxYQ eJcDNr sc-4d881605-5 bpsGtj">VENHA SER #SANGUELARANJA 🧡🚀</p>
                  </div>
              </div>
              <h3 font-family="'Inter', sans-serif" color="#27262A" my="0" id=""
                  class="sc-bZkfAO gYfAYo sc-4d881605-4 dZRYPZ">${job.name} </h3>
                  ...
                  <div data-testid="listing-details" class="sc-66f01f61-0 OtNUi">
                      ...
                      ${
                        ...
                        <div aria-label="This job is also for People with Disabilities." id="" role="group"
                          ...
                          <div class="sc-dkzDqf eNgrhv"><svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24"
                                  aria-hidden="true" alt="Accessibility Icon">
